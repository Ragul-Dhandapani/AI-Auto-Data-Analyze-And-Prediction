...
async def holistic_analysis(request: Dict[str, Any]):
    ...
    try:
        ...
        SAMPLE_THRESHOLD = 50000  # Only sample if more than 50k rows
        SAMPLE_SIZE = 10000  # Use 10k rows for training
        is_sampled = False
        ...
        if target_cols and len(target_cols) > 0:
            ...
            if domain_info and domain_info.get("visualization_config") and len(df_analysis) <= 50000:
                try:
